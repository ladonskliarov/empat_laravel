        ...
        <div class="brigades">
            @foreach($brigades as $brigade)
                <div class="brigade">
                    ...
                    <a href="{{ route('brigades.show', $brigade->id) }}"><img src="{{ asset('storage/' . $brigade->image) }}" alt="{{ $brigade->name }} image" style="width: auto; height: 300px; margin-top: 20px; margin-bottom: 20px;"></a>
                    <h3>Битви</h3>
                    <ul>
